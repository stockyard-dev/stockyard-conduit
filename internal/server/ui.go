...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> CONDUIT</h1>
...
var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "name", "label": "Name", "type": "text"}, {"name": "source_type", "label": "Source Type", "type": "text"}, {"name": "target_type", "label": "Target Type", "type": "text"}, {"name": "config", "label": "Config", "type": "text"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "sync_count", "label": "Sync Count", "type": "integer"}, {"name": "last_sync_at", "label": "Last Sync At", "type": "text"}, {"name": "created_at", "label": "Created At", "type": "text"}];
